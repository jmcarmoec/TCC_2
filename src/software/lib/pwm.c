...
void init_PWM(){    
    LPC_SYSCON->SYSAHBCLKCTRL     |= (1<<7); // Habilita clock do Timer 0 de 16 bits (Pag. 30)
      ...
      */
      ...
      LPC_TMR16B0->MR3 = PERIOD_SERVO_MOTOR_0*1000;//Define o período de 20 ms (pag. 331)
      LPC_TMR16B0->MR0 = PERIOD_SERVO_MOTOR_0*1000; // Define o duty cycle de 1.7 ms (pag. 331)   
      ...
      LPC_TMR16B0->PWMC = 0x1; //Define PWM para o registrador MR0. (pag. 335)
